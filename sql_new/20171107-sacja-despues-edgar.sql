...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2017 a las 01:46:53
...
CREATE TABLE `asistenciareuniones` (
...
CREATE TABLE `asociaciones_misiones` (
...
CREATE TABLE `categoriasespecialidades` (
...
CREATE TABLE `clases_club` (
  `id_claseclub` int(10) NOT NULL,
...
CREATE TABLE `especialidadesterminadas` (
...
CREATE TABLE `observacionesespecialidadterminada` (
  `idObservacionEspecialidadTerminada` int(10) NOT NULL,
  `especialidad` int(10) NOT NULL,
...
CREATE TABLE `tiposclub` (
  `idTipoClub` int(10) NOT NULL,
  `tipoClub` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tiposclub` (`idTipoClub`, `tipoClub`) VALUES
(1, 'Castores'),
(2, 'Aventureros'),
(3, 'Conquistadores'),
(4, 'Guías Mayores'),
...
(1, '', '', '', 'daniel@sacja.com', '3d0f3b9ddcacec30c4008c5e030e6c13a478cb4f', '', '0000-00-00', '', 0, 0, '', '', '', '');
...
--
-- Indices de la tabla `clases_club`
--
ALTER TABLE `clases_club`
  ADD PRIMARY KEY (`id_claseclub`);
...
--
-- Indices de la tabla `especialidadclub`
--
ALTER TABLE `especialidadclub`
...
--
-- Indices de la tabla `mov_dinero`
--
ALTER TABLE `mov_dinero`
...
--
-- Indices de la tabla `observacionesespecialidadterminada`
--
ALTER TABLE `observacionesespecialidadterminada`
  ADD PRIMARY KEY (`idObservacionEspecialidadTerminada`);
...
--
-- Indices de la tabla `tiposclub`
--
ALTER TABLE `tiposclub`
  ADD PRIMARY KEY (`idTipoClub`);
...
--
-- AUTO_INCREMENT de la tabla `clases_club`
--
ALTER TABLE `clases_club`
  MODIFY `id_claseclub` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `clubes`
--
ALTER TABLE `clubes`
  MODIFY `idClub` int(10) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `especialidadclub`
--
ALTER TABLE `especialidadclub`
...
--
ALTER TABLE `miembros`
  MODIFY `idMiembro` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `mov_dinero`
--
ALTER TABLE `mov_dinero`
...
--
-- AUTO_INCREMENT de la tabla `observacionesespecialidadterminada`
--
ALTER TABLE `observacionesespecialidadterminada`
  MODIFY `idObservacionEspecialidadTerminada` int(10) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `permisos`
  MODIFY `idPermiso` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tipodesangre`
  MODIFY `idTipoDeSangre` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `tiposclub`
--
ALTER TABLE `tiposclub`
  MODIFY `idTipoClub` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
