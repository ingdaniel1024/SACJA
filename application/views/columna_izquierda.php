        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a><i class="fa fa-sitemap"></i> Director <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                    ...
                    <li>
                        <a><i class="fa fa-usd"></i> Tesorero <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="#">Opciones</a></li>
                        </ul>
                    </li>
                    <li>
                        <a><i class="fa fa-calendar-o"></i> Secretario <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="#">Opciones</a></li>
                        </ul>
                    </li>
                    <li>
                        <a><i class="fa fa-bicycle"></i> Instructor <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="#">Opciones</a></li>
                        </ul>
                    </li>
                    <li>
                        <a><i class="fa fa-group"></i> Consejero <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="#">Opciones</a></li>
                        </ul>
                    </li>
                    <li>
                        <a><i class="fa fa-binoculars"></i> Conquistador <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="#">Opciones</a></li>
                        </ul>
                    </li>
