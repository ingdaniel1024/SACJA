...
<div class="">
    <div class="page-title">
        <div class="title_left">
            ...
            ?>
            <h3>Directiva del Club <?php echo $nombreClubActual;?></h3>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <form class="form-horizontal" action="proc/agregarDirectiva.php" method="POST">
                    ...
                    if (hayDirectiva()) {
                        ...
                        while($a=$buscar->fetch_array()){
                            ...
                            while($b=$bNombre->fetch_array()){
                                ...
                                $correoUsuarioDirectiva = $b['correo'];
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$a['cargo'].'</td>
                                    <td>
                                        <a href="?pagina=perfil&perfil='.$correoUsuarioDirectiva.'">
