...
// Default Properties and Events
    $.fn.smartWizard.defaults = {
        ...
        onFinish: function(){
            //Enviar formulario
            //Agregar la información del formulario de Club al formulario de Director, para manejar un solo formulario
            $('#formularioRegistroClub :input').not(':submit').clone().hide().appendTo('#formularioRegistroDirector');
            $("#formularioRegistroDirector").submit();
